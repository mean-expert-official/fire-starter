...
import { SDKToken, FireUser } from '../models';
...
Object.assign(BaseLoopbackActionsFactory<FireUser>('User', UserActionTypes), {
  /**
   * @author João Ribeiro <@JonnyBGod> <github:JonnyBGod>
   * @description
  ...
  findByIdApps: class implements Action {
    ...
    constructor(public payload: {id: any, fk: any}) { }
  },
  ...
  updateByIdApps: class implements Action {
    ...
    constructor(public payload: {id: any, fk: any, data: any}) { }
  },
